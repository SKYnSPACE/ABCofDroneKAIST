...
// 개발중 디버깅용으로 사용. 비행코드 업로드시 주석처리
  ...
  //![6] 각종 변수 초기화
    ...
    Sensor.Receiver.channel1Center = 1500; //! Check the Transmitter Settings
    ...
    Sensor.Receiver.channel2Min = 1900;
    Sensor.Receiver.channel3Min = 1100;
    Sensor.Receiver.channel4Min = 1100;
    Sensor.Receiver.channel1Max = 1900;
    Sensor.Receiver.channel2Max = 1100;
    Sensor.Receiver.channel3Max = 1900;
    Sensor.Receiver.channel4Max = 1900;
...
//
  ...
  while((Sensor.Battery.batteryVoltage<11.1) || 
        ...
        (Sensor.Receiver.channel1Input > Sensor.Receiver.channel1Max) ||
        (Sensor.Receiver.channel3Input > Sensor.Receiver.channel3Min)) //! Check the Transmitter Settings
  {
...
// TBD: Switch-Case 로 대체
  ...
  if((Flags.flightMode == 0) &&
     ...
     (Sensor.Receiver.channel2Input == Sensor.Receiver.channel2Min) &&
     ((Sensor.Receiver.channel1Input == Sensor.Receiver.channel1Min)||(Sensor.Receiver.channel1Input == Sensor.Receiver.channel1Max)))
  {
    Motor.outputPWM1 = 1150;
    Motor.outputPWM2 = 1150;
    Motor.outputPWM3 = 1150;
  ...
  if((Flags.flightMode == 2) && (Sensor.Receiver.channel3Input <= (Sensor.Receiver.channel3Min+20)))
  {
    Motor.outputPWM1 = 1150;
    Motor.outputPWM2 = 1150;
    Motor.outputPWM3 = 1150;
  ...
  if(((Flags.flightMode == 1) || (Flags.flightMode == 2)) && 
     (Sensor.Receiver.channel3Input > (Sensor.Receiver.channel3Min+20)))
  {
    Flags.flightMode = 3;
  }
  ...
  if((Flags.flightMode == 3) && (Sensor.Receiver.channel3Input <= (Sensor.Receiver.channel3Min+20)))
  {
    Flags.flightMode = 2;
  }
