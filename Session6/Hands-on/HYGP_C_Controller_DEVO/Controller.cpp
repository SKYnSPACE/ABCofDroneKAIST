...
void PIDController()
{
  ...
  Controller.pReference /= 8; // [4: -103 ~ 0 ~ 103 deg/s command ref. from pilot]
  Controller.qReference /= 8; // [8: -51.5 ~ 0 ~ 51.5 deg/s command ref. from pilot]
  Controller.rReference /= 8; // 작은값으로 나눌수록 aggressive
